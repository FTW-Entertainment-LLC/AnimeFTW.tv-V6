				...
				else if(($_GET['stage'] == 'edit' && $this->ValidatePermission(23) == TRUE) || ($_GET['stage'] == 'addseries' && $this->ValidatePermission(22) == TRUE))
				{
					...
					<div id="series-wrapper">
						...
						<div class="series-form-row">
							...
							<div class="series-form-right">
								<div align="center" style="display:inline-block;"><img src="/images/ratings/e.jpg" alt="Everyone" /><br /><input type="radio" name="ratingLink" value="e.jpg" '; if($ratingLink == 'e.jpg'){echo 'checked="checked"';} echo ' /></div>
								<div align="center" style="display:inline-block;"><img src="/images/ratings/12+.jpg" alt="12+" /><br /><input type="radio" name="ratingLink" value="12+.jpg" '; if($ratingLink == '12+.jpg'){echo 'checked="checked"';} echo '  /></div>
								<div align="center" style="display:inline-block;"><img src="/images/ratings/15+.jpg" alt="15+" /><br /><input type="radio" name="ratingLink" value="15+.jpg" '; if($ratingLink == '15+.jpg'){echo 'checked="checked"';} echo '  /></div>
								<div align="center" style="display:inline-block;"><img src="/images/ratings/18+.jpg" alt="18+" /><br /><input type="radio" name="ratingLink" value="18+.jpg" '; if($ratingLink == '18+.jpg'){echo 'checked="checked"';} echo '  /></div>
							</div>
						</div>
						<div class="series-form-row">
