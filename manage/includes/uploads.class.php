...
class Uploads extends Config {
	...
	private function BuildRow($Status)
	{
		...
		echo '<div class="uploads-row-top" style="width:860px;height:14px;padding-bottom:5px;border-bottom:1px solid #99e6ff;">
				...
				<div style="display:inline-block;width:490px;font-size:13px;" align="left">Entry Name</div>
				...
				<div style="display:inline-block;width:105px;font-size:13px;" align="center">Encoder</div>
		...
		else 
		{
			...
			while($row = mysql_fetch_array($results, MYSQL_NUM))
			{
				...
				echo '<div class="uploads-row-top" style="width:860px;height:14px;padding-bottom:5px;">
						...
						<div style="display:inline-block;width:490px;" align="left"><span title="' . stripslashes($row[1]) .'">' . $Project . '</span></div>
						...
						<div style="display:inline-block;width:105px;" align="center">' . $this->formatUsername($row[7],'blank') . '</div>
